...
#OMP_NUM_THREADS=8 nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/torchrun --standalone --nproc_per_node 8 train.py config/cont_train_gpt2_owm_rho.py --wandb_log=True --compile=True --wandb_run_name='cont-tinyllama-1.1B-0.4rho' --out_dir='out/cont-tinyllama-1.1B-owm-7.5B-0.4rho' --init_from='../TinyLlama_v1.1' --ref_model_ckpt="../TinyLlama_v1.1_math_code"  --dataset='/cpfs/user/fengmingquan/dataset/processed-llama2/open-web-math' --batch_size=6 --gradient_accumulation_steps=80 --block_size=2048 --token_keep_ratio=0.4 > log/gpt-owm-rho-1.log 2>&1 &


#OMP_NUM_THREADS=8 nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/torchrun --standalone --nproc_per_node 8 train.py config/cont_train_gpt2_owm_rho.py --wandb_log=True --compile=True --wandb_run_name='cont-tinyllama-1.1B' --out_dir='out/cont-tinyllama-1.1B-owm-15B' --init_from='TinyLlama/TinyLlama_v1.1' --ref_model_ckpt=""  --dataset='/cpfs/user/fengmingquan/dataset/processed-llama2/open-web-math' --batch_size=6 --gradient_accumulation_steps=80 --block_size=2048 --token_keep_ratio=1.0 > log/gpt-owm-rho-2.log 2>&1 &
