...
CUDA_VISIBLE_DEVICES=4,5,6,7 OMP_NUM_THREADS=8 nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/torchrun --standalone --nproc_per_node 4 train.py config/cont_train_gpt2_owm_rho.py --wandb_log=True --use_deepspeed=True --zero_stage=2 --wandb_run_name='qwen2-0.5B-bio-raw' --out_dir='out-prodcpfs/qwen2-0.5B-bio-raw' --init_from='/prodcpfs/user/fengmingquan/model/Qwen2-0.5B' --ref_model_ckpt=''   --dataset='/prodcpfs/user/fengmingquan/dataset/processed-qwen2' --train_mode='scratch' --dataset_prefix="phys-llm-31-bio,phys-llm-31-story" --dataset_ratio="50:0" --batch_size=40 --gradient_accumulation_steps=24 --block_size=512 --token_keep_ratio=1.0 --max_iters=40000 --lr_decay_iters=40000 --learning_rate=1e-4 --min_lr=1e-5  > log/gpt-owm-rho-4.log 2>&1 &



OMP_NUM_THREADS=8 nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/torchrun --standalone --nproc_per_node 4 train.py config/cont_train_gpt2_owm_rho.py --wandb_log=True --use_deepspeed=True --zero_stage=2 --wandb_run_name='qwen2-0.5B-bio-rewrite' --out_dir='out-prodcpfs/qwen2-0.5B-bio-rewrite' --init_from='/prodcpfs/user/fengmingquan/model/Qwen2-0.5B' --ref_model_ckpt=''   --dataset='/prodcpfs/user/fengmingquan/dataset/processed-qwen2' --train_mode='scratch' --dataset_prefix="phys-llm-31-bio,phys-llm-31-story" --dataset_ratio="50:50" --batch_size=40 --gradient_accumulation_steps=24 --block_size=512 --token_keep_ratio=1.0 --max_iters=40000 --lr_decay_iters=40000 --learning_rate=1e-4 --min_lr=1e-5  > log/gpt-owm-rho-3.log 2>&1 &
