...
# download data by:
input_path = "/prodcpfs/user/fengmingquan/dataset/raw/megamath/megamath-qa"
output_path = "/prodcpfs/user/fengmingquan/dataset/processed-qwen2/megamath-qa"
...
if __name__ == '__main__':
    ...
    dataset = load_dataset(input_path, streaming=False, num_proc=num_proc_load_dataset)
...
# nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/python data/megamath/prepare_hf.py > log/prepare_hf_6.log 2>&1 &


# processed-qwen2/megamath-text-code-block/train.bin = 42B tokens
# processed-qwen2/megamath-translated-code/train.bin = 5.6B tokens.
# processed-qwen2/megamath-qa/train.bin = 6.4B tokens.