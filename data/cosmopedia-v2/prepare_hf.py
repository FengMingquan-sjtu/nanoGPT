...
# download data by:
input_path = "/oss/crawl/multimodal/HuggingFaceTB/smollm-corpus"
output_path = "/prodcpfs/user/fengmingquan/dataset/processed-qwen2/copy-cosmopedia-v2"
...
if __name__ == '__main__':
    ...
    dataset = load_dataset(input_path, "cosmopedia-v2", num_proc=num_proc_load_dataset)
...
# nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/python data/cosmopedia-v2/prepare_hf.py > log/prepare_hf_13.log 2>&1 &
