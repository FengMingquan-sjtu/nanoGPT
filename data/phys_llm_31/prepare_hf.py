...
output_path = "/prodcpfs/user/fengmingquan/dataset/processed-qwen2/phys-llm-31-story"
...
if __name__ == '__main__':
    ...
    def process(example):
        ...
        if output_path.endswith("bio"):
            text = example['id'] + ": " + example['demographic_summary']
        elif output_path.endswith("story"):
            text = example['id'] + ": " + example['background_story']
        else:
            raise ValueError("output_path should end with bio or story")
...
# nohup /cpfs/user/fengmingquan/miniconda3/envs/nanogpt/bin/python data/phys_llm_31/prepare_hf.py > log/prepare_hf_9.log 2>&1 &
