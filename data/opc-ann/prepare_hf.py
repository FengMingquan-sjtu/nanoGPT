...
if __name__ == '__main__':
    ...
    tokenizer_name_to_folder = {
        "gpt2": "gpt2",
        "qwen2": "Qwen2-0.5B",
        # Add more tokenizers as needed
    }
    tokenizer_path = os.path.join("/prodcpfs/user/fengmingquan/model/", tokenizer_name_to_folder[tokenizer_name]) 
    tokenizer = AutoTokenizer.from_pretrained(tokenizer_path)

    
    input_folders = [f for f in os.listdir(input_root) if f.startswith(dataset_prefix) and os.path.isdir(os.path.join(input_root, f))]
